...
function Checkproduct3() {
    ...
    const products = useSelector(state => state.checkproductReducer3.value); // products is an array
...
//   useEffect(() => {
    ...
    return (
        <>
            ...
            {products.length > 0 && products.filter((item)=>item.catageory==="tv").map((eachProduct, index) => {
                    return (
